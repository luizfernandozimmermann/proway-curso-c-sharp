...
{
    public partial class CadastroClienteFrom : Form
    {
        private ClienteServico clienteServico;

        public CadastroClienteFrom()
        {
            InitializeComponent();
        ...
        private void BuscarEnderecoPorCep()
        {
            ...
            if (response.StatusCode == HttpStatusCode.OK) // 200
            {
                ...
                var endereco = JsonConvert
                    .DeserializeObject<Dictionary<string, string>>(responseTexto);
